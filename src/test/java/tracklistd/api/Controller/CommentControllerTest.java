...
public class CommentControllerTest {
    ...
    void createComment_deveRetornar201_quandoDadosValidos() throws Exception {
        ...
        when(commentService.getCommentLikes(testPost)).thenReturn(5L);
        when(commentMapper.toResponseDTO(testComment, 5L)).thenReturn(testResponseDto);
    ...
    void getPostComments_deveRetornar404_quandoPostNaoEncontrado() throws Exception {
        when(publicationService.getPublicationById(999L)).thenThrow(new ResourceNotFoundException("Post not found"));
